...
public class MultiStage {
    ...
    private final List<List<Integer>> strings;
    private final Map<Integer, Integer> hashMap;
    private final Map<String, Integer> map;
    private final Map<Integer, String> mapString;

    private static final int SUPPORT = 70;

    public MultiStage(List<List<String>> list) {
        hashMap = new HashMap<>();
        map = new HashMap<>();
        mapString = new HashMap<>();
        this.strings = stringsFrom(list);
    }

    public List<List<Integer>> stringsFrom(List<List<String>> list) {
        int k = 1;
